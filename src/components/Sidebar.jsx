...
export default function Sidebar({ conversations, activeId, onNewChat, onSelectChat, isOpen, onToggle, onBackToLanding }) {
    return (
        <>
            {/* Mobile overlay */}
            ...
            <aside className={`sidebar ${isOpen ? 'sidebar--open' : ''}`}>
                ...
                <div className="sidebar__footer">
                    <button className="sidebar__back-btn" onClick={() => {
                        // Dispatch logout event if needed, or just navigate back
                        onBackToLanding();
                    }}>
